...
class Classifier:
    ...
    def __init__(self, currentdir, bucketPrefix, testBucketNumber, dataFormat):
    ...
    def testBucket(self, currentdir, bucketPrefix, bucketNumber):
...
def test(training_filename, test_filename):
    ...
    for line in lines:
        ...
        # predicted class - row -  theClass
        # actual class - columns - data[classInColumn]
        confusionMatrix.setdefault(data[classInColumn], {})
        confusionMatrix[data[classInColumn]].setdefault(theClass,0)
        confusionMatrix[data[classInColumn]][theClass] += 1
...
def tenfold(currentdir, bucketPrefix, dataFormat):
    results = {}
    for i in range(1, 11):
        c = Classifier(currentdir, bucketPrefix, i, dataFormat)
        t = c.testBucket(currentdir, bucketPrefix, i)
...
#  test("..\\data\\ch4\\irisTrainingSet.data", "..\\data\\ch4\\irisTestSet.data")
# test("../data/ch4/mpgTrainingSet.txt", "../data/ch4/mpgTestSet.txt")
    
# cl = Classifier('../data/ch4/athletesTrainingSet.txt')
# print(cl.classify([73, 160]))

# The first file as training file will contain the first line as format
# mpg file format: "class	num	num	num	num	num	comment"
# test("../data/ch5/mpgData/mpgData/mpgData-01", "../data/ch5/mpgData/mpgData/mpgData-02")

# class num num num num num comment

tenfold("../data/ch5/mpgData/mpgData", "mpgData", "class	num	num	num	num	num	comment")
