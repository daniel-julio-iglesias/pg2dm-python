...
def buckets(filename, bucketName, separator, classColumn):
    ...
    # mpg file format: "class	num	num	num	num	num	comm"
...
# currentdir = '../data/ch5/pimaSmall/pimaSmall'
# buckets(currentdir + '/'+ 'pimaSmall.txt', currentdir + '/'+ 'pimaSmall',',',8)


currentdir = '../data/ch5/mpgData/mpgData'
buckets(currentdir + '/'+ 'mpgData.txt', currentdir + '/'+ 'mpgData','\t',0)
