...
def main():
    # print("recommend('Veronica', users) => ", recommend('Veronica', users))
    # print("manhattan(users['Angelica'], users['Veronica']) => ", manhattan(users['Angelica'], users['Veronica']))


    # print('manhattan(music["Dr Dog/Fate"], music["Glee Cast/Jessie\'s Girl"]) => ', manhattan(music["Dr Dog/Fate"], music["Glee Cast/Jessie's Girl"]))
    # print('manhattan(music["Lady Gaga/Alejandro"], music["Glee Cast/Jessie\'s Girl"]) => ', manhattan(music["Lady Gaga/Alejandro"], music["Glee Cast/Jessie's Girl"]))
    

    # print('euclidean(music["Dr Dog/Fate"], music["Glee Cast/Jessie\'s Girl"]) => ', euclidean(music["Dr Dog/Fate"], music["Glee Cast/Jessie's Girl"]))
    # print('euclidean(music["Lady Gaga/Alejandro"], music["Glee Cast/Jessie\'s Girl"]) => ', euclidean(music["Lady Gaga/Alejandro"], music["Glee Cast/Jessie's Girl"]))

    # print("computeNearestNeighbor('The Black Keys/Magic Potion', music) => ", computeNearestNeighbor('The Black Keys/Magic Potion', music))
    # print("computeNearestNeighbor('Phoenix/Lisztomania', music) => ", computeNearestNeighbor('Phoenix/Lisztomania', music))
    print("computeNearestNeighbor('Lady Gaga/Alejandro', music) => ", computeNearestNeighbor('Lady Gaga/Alejandro', music))
